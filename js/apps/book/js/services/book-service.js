...
function addGoogleBook(googleBook) {
    ...
    const convertedBook = {
        ...
        catagories: googleBook.catagories,
        thubnail: googleBook.imageLinks.thumbnail,
...
function queryGoogleBooks(userBookInput) {
    return axios.get(`https://www.googleapis.com/books/v1/volumes?printType=books&q=effective%20${userBookInput}`).then(res => {
        console.log('res', res.data.items)
        return res.data.items
            // .volumeInfo.title)
            // this.booksArray = res.data.items
            // console.log('bboks array', this.booksArray)
    })
}
