...
export default {
    template: `
            <section>
                <div>
                    <!-- <router-link to="/about"><div class="round-hover-modal about-btn">About</div></router-link> -->
                    ...
                    <!-- <router-link to="'/books"><div class="round-hover-modal missBooks-btn">MissBooks</div></router-link> -->
                 </div>
              </section>
    `,
    components: {
